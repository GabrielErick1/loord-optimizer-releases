...
(function adbUI() {
  ...
  btnUninstall.addEventListener('click', async () => {
    ...
    btnUninstall.textContent = 'Concluído ✔';
  });
  ...
  btnFullOptimize.addEventListener('click', async () => {
    ...
    btnFullOptimize.textContent = 'Otimizando...';
    ...
    btnFullOptimize.textContent = '✔ Tudo Aplicado!';
  });
})();
// ═══════════════════════════════════════════════════════════════════════
